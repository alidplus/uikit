...
import { selectEvenlySpacedItems } from '../utils';
import { useBreakpoint } from './useBreakpoint';
import styles from './bar-charts.module.scss';

const barData = [
  { month: new Date(2025, 0, 1), A: 300, B: 200, C: 350 },
  { month: new Date(2025, 1, 1), A: 320, B: 300, C: 300 },
  { month: new Date(2025, 2, 1), A: 300, B: 200, C: 240 },
  { month: new Date(2025, 3, 1), A: 240, B: 300, C: 280 },
  { month: new Date(2025, 4, 1), A: 320, B: 280, C: 100 },
  { month: new Date(2025, 5, 1), A: 330, B: 300, C: 130 },
  { month: new Date(2025, 6, 1), A: 300, B: 200, C: 100 },
  { month: new Date(2025, 7, 1), A: 350, B: 300, C: 200 },
  { month: new Date(2025, 8, 1), A: 300, B: 200, C: 100 },
  { month: new Date(2025, 9, 1), A: 200, B: 300, C: 280 },
  { month: new Date(2025, 10, 1), A: 240, B: 300, C: 300 },
  { month: new Date(2025, 11, 1), A: 200, B: 400, C: 350 },
];

export const BarChart01 = () => {
  const isDesktop = useBreakpoint('lg');
  const colors: Record<string, string> = {
    A: styles.colorBrand700,
    B: styles.colorBrand500,
    C: styles.colorGray200,
  };
  ...
  return (
    <ResponsiveContainer className={styles.responsiveContainer}>
      ...
      >
        ...
        >
          <Label value="Month" fill="currentColor" className={styles.labelXs} position="bottom" />
        </XAxis>
        <YAxis
          fill="currentColor"
          axisLine={false}
        ...
        <Tooltip
          ...
          cursor={{ className: styles.cursorGray200 }}
        />
        <Bar
